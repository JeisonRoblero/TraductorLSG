          ...
          child: Column(
            children: [
              PlatformButton(
                        ...
                        physicalModel: true,
                        title: buildTitle(textColors[0], "Versión 1.0", "Modelo de Lengua de Señas Guatemalteco Con Precisión del 65.4%", "65.4%"),
              ),
              PlatformButton(
                        onPressed: () => {},
                        ...
                        padding: const EdgeInsets.symmetric(horizontal: 10.0, vertical: 15.0),
                        physicalModel: true,
                        title: buildTitle(textColors[2], "Versión 2.0", "Modelo de Lengua de Señas Guatemalteco Con Precisión del 71.6%", "71.6%"),
              ),
              const SizedBox(height: 100),
              Container(margin: const EdgeInsets.symmetric(horizontal: 15.0), child: Text("Graficas de Modelos de IA de Lengua de Señas Guatemalteco", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 28, color: colorScheme.primary),)),
              PlatformButton(
                onPressed: () {},
