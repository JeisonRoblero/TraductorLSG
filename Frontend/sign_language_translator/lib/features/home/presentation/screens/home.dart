        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Container(margin: const EdgeInsets.symmetric(horizontal: 15.0), child: Text("Modelos de IA de Lengua de Señas Guatemalteco", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 28, color: colorScheme.primary),)),
              PlatformButton(
                onPressed: () {},
